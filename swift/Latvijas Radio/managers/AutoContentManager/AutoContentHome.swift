...
class AutoContentHome: NSObject {
    ...
    func handleBroadcastNewsEpisodeResponse(_ data: [String: Any]) {
        ...
        if let episodes = data[BroadcastEpisodesRequest.RESPONSE_PARAM_EPISODES] as? [[String: Any]] {
        ...
        } else if let episodes = data[BroadcastEpisodesRequest.RESPONSE_PARAM_RESULTS] as? [[String: Any]] {
