...
//     static let HOST = "https://lr-api.pieci.lv" // test
    static let HOST_SEARCH = "https://www.latvijasradio.lsm.lv"
    static let HOST = "https://mapp.latvijasradio.lv" // production
    static let API_URL = HOST + "/api"
    static let API_URL_SEARCH = HOST_SEARCH + "/api/"
    static let PASSWORD_MIN_LENGTH = 8
    static let FORM_DISABLED_STATE_OPACITY = 0.4
    static let SEARCHURL = "https://search.latvijasradio.lv/collections/lrapp/documents/search"
    static let X_TYPESENSE_API_KEY = "y2l0PdomDCLw4nlJ6ZRUx0urb9ww6pVu"
    //"5JsQS8C56v1DMh22nbX79K2lmRPekRR9" // x-typesense-api-key
    // Production API key: y2l0PdomDCLw4nlJ6ZRUx0urb9ww6pVu
