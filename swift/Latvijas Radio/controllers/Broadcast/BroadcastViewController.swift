...
class BroadcastViewController: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let customFont = UIFont(name: "FuturaPT", size: 11.0)
...
//                   }
        ...
        let customFont2 = UIFont(name: "FuturaPT", size: 13.0)
        ...
        let customFont3 = UIFont(name: "FuturaPT-Bold", size: 18.0)
        ...
        textHosts.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont2 ?? UIFont.systemFont(ofSize: 10.0))
        textHosts.adjustsFontForContentSizeCategory = true
        textAvailableEpisodes.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont3 ?? UIFont.systemFont(ofSize: 18.0))
