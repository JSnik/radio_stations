...
class NewsCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        GeneralUtils.log(NewsCollectionViewController.TAG, "viewWillAppear")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let customFont = UIFont(name: "FuturaPT-Bold", size: 17.0)
        cell.textEpisodeTitle.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont ?? UIFont.systemFont(ofSize: 17.0))
