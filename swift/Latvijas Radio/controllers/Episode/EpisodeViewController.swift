...
class EpisodeViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let customFont = UIFont(name: "FuturaPT-Bold", size: 10.0)
        textMoreAboutThisTopic.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont ?? UIFont.systemFont(ofSize: 16.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            textMoreAboutThisTopic.font = UIFont(descriptor: artistDescriptor,
                                size: 16.0)
        }
        textMoreAboutThisTopic.adjustsFontForContentSizeCategory = true
        let customFont1 = UIFont(name: "FuturaPT", size: 13.0) //UIFont.systemFont(ofSize: 13.0)
        ...
        let customFont2 = UIFont.systemFont(ofSize: 22.0)
        let customFont4 = UIFont.systemFont(ofSize: 10.0)
        textDate.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont4 ?? UIFont.systemFont(ofSize: 10.0))
        textDate.adjustsFontForContentSizeCategory = true
        textTitle.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont2 ?? UIFont.systemFont(ofSize: 22.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {
        ...
        textHosts.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont4 ?? UIFont.systemFont(ofSize: 10.0))
        textHosts.adjustsFontForContentSizeCategory = true
        let customFont3 = UIFont(name: "FuturaPT", size: 10.0)
...
//        textMoreAboutThisTopic.adjustsFontForContentSizeCategory = true
    ...
    func setMockNotFoundEpisodeData() {
        episodeModel = EpisodeModel("0")
        episodeModel.setTitle("Not Found")
        episodeModel.setCategoryName("Not Found")
    }
...
//            if let  ep1 = EpisodesHelper.getEpisodeFromJsonObject(data) {
//                self?.episodeModel = ep1
//                self?.continueWithAcquiredEpisodeData()
//            } else {
//                self?.textTitle.text = "Episode not found"
//            }
