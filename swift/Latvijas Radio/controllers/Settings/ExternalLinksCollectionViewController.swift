...
extension ExternalLinksCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let customFont8 = UIFont(name: "FuturaPT-Bold", size: 13.0)
        cell.buttonExternalLink.titleLabel?.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont8 ?? UIFont.systemFont(ofSize: 13.0))
        cell.buttonExternalLink.titleLabel?.adjustsFontForContentSizeCategory = true
        cell.buttonExternalLink.adjustsImageSizeForAccessibilityContentSizeCategory = true
        //        buttonSupport.titleLabel?.numberOfLines = 0
        cell.buttonExternalLink.titleLabel?.adjustsFontSizeToFitWidth = true
