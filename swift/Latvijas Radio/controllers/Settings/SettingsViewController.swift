...
class SettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let customFont4 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        buttonLanguage.titleLabel?.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont4 ?? UIFont.systemFont(ofSize: 12.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            buttonLanguage.titleLabel?.font = UIFont(descriptor: artistDescriptor,
                                size: 12.0)
        }
...
//        buttonLanguage.titleLabel?.adjustsFontSizeToFitWidth = true
        ...
        let customFont5 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        buttonSupport.titleLabel?.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont5 ?? UIFont.systemFont(ofSize: 12.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            buttonSupport.titleLabel?.font = UIFont(descriptor: artistDescriptor,
                                size: 12.0)
        }
        buttonSupport.titleLabel?.adjustsFontForContentSizeCategory = true
        buttonSupport.adjustsImageSizeForAccessibilityContentSizeCategory = true
//        buttonSupport.titleLabel?.numberOfLines = 0
        buttonSupport.titleLabel?.adjustsFontSizeToFitWidth = true
        
        let customFont6 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        buttonCookies.titleLabel?.font = UIFontMetrics(forTextStyle: .body).scaledFont(for: customFont6 ?? UIFont.systemFont(ofSize: 12.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            buttonCookies.titleLabel?.font = UIFont(descriptor: artistDescriptor,
                                size: 12.0)
        }
        buttonCookies.titleLabel?.adjustsFontForContentSizeCategory = true
        buttonCookies.adjustsImageSizeForAccessibilityContentSizeCategory = true
//        buttonSupport.titleLabel?.numberOfLines = 0
        buttonCookies.titleLabel?.adjustsFontSizeToFitWidth = true
        
        let customFont7 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        buttonChangeLivestreamsOrderInDashboard.titleLabel?.font = UIFontMetrics(forTextStyle: .body).scaledFont(for: customFont7 ?? UIFont.systemFont(ofSize: 12.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            buttonChangeLivestreamsOrderInDashboard.titleLabel?.font = UIFont(descriptor: artistDescriptor,
                                size: 12.0)
        }
        buttonChangeLivestreamsOrderInDashboard.titleLabel?.adjustsFontForContentSizeCategory = true
        buttonChangeLivestreamsOrderInDashboard.adjustsImageSizeForAccessibilityContentSizeCategory = true
//        buttonSupport.titleLabel?.numberOfLines = 0
        buttonChangeLivestreamsOrderInDashboard.titleLabel?.adjustsFontSizeToFitWidth = true
        buttonChangeLivestreamsOrderInDashboard.setNeedsLayout()

        let customFont8 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        buttonNotifications.titleLabel?.font = UIFontMetrics(forTextStyle: .body).scaledFont(for: customFont8 ?? UIFont.systemFont(ofSize: 12.0))
        if let artistDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).withSymbolicTraits(.traitBold) {

            buttonNotifications.titleLabel?.font = UIFont(descriptor: artistDescriptor,
                                size: 16.0)
        }
        buttonNotifications.titleLabel?.adjustsFontForContentSizeCategory = true
        buttonNotifications.adjustsImageSizeForAccessibilityContentSizeCategory = true
//        buttonSupport.titleLabel?.numberOfLines = 0
        buttonNotifications.titleLabel?.adjustsFontSizeToFitWidth = true
...
//        buttonLanguage.titleLabel?.minimumScaleFactor = 0.5
        ...
        let customFont1 = UIFont(name: "FuturaPT-Bold", size: 22.0)
        ...
        let customFont2 = UIFont(name: "FuturaPT-Bold", size: 12.0)
        ...
        let customFont3 = UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 16.0)
        ...
        textVersion.font = UIFontMetrics(forTextStyle: .headline).scaledFont(for: customFont3 ?? UIFont.systemFont(ofSize: 14.0))
