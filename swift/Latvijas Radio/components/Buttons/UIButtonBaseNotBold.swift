//
//  UIButtonBaseNotBold.swift
//  Latvijas Radio
//
//  Created by andriy kruglyanko on 28.12.2024.
//  Copyright © 2024 Latvijas Radio. All rights reserved.
//

import UIKit

@IBDesignable class UIButtonBaseNotBold: UIButton {
...
//        UIFont(name: FontsHelper.FUTURA_PT_DEMI, size: 12.0)
        self.titleLabel?.font = UIFontMetrics(forTextStyle: .body).scaledFont(for: customFont1 ?? UIFont.systemFont(ofSize: 13.0))
