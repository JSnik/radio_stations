      ...
      child: ChangeNotifierProvider.value(
          ...
          child: Consumer<MainScreenProvider>(builder: (context, mainScreenProvider, _) {
            ...
            if (mainScreenProvider.mainScreenData.data.isNotEmpty) {
              mainData = mainScreenProvider.mainScreenData.data[mainScreenProvider.currentSelectedPlaylistIndex];
              ...
              children: [
                CustomCarouselSlider(
                  ...
                  options: CarouselOptions(
                    scrollPhysics: mainScreenProvider.appBarIsExpanded ? null : const NeverScrollableScrollPhysics(),
                      height: 50000,
                      viewportFraction: 1,
                      disableCenter: false,
                      initialPage: 0,
                ...
                mainScreenProvider.appBarIsExpanded ? const SizedBox() :
                Positioned(
                    top: 0,
                    child: Image.asset(
                  ...
                  children: [
                    AppBarMainScreenWidget(
                      ...
                      onRadioIconTap: (index) {
                        //_closeAppBar();
                        if (index != null) {
                          mainScreenProvider.setPlaylistOnHomePage(index, context);
                          // context.read<PlayerProvider>().carouselSliderControllerAppBar.animateToPage(index, duration: const Duration(milliseconds: 500));
                          // context.read<PlayerProvider>().carouselSliderControllerMainCell.animateToPage(index, duration: const Duration(milliseconds: 500));
                      ...
                      appBarIsExpanded: mainScreenProvider.appBarIsExpanded,
                      onItemFocus: (index) {
                        mainScreenProvider.setPlaylistOnHomePage(index, context);
                      },
